...
import api.petstore.endpoints.UserEndPointsFromProperties;
import api.petstore.payloads.User;
import io.restassured.response.Response;

public class UserTestsUsingEndPointsFromProp {
	Faker faker;
	User userPayload;
public Logger logger;
	...
	public void postUserDetails() {
		...
		Response resonse = UserEndPointsFromProperties.createUser(userPayload);
	...
	public void getUserByName() {
		...
		Response resonse = UserEndPointsFromProperties.readUser(this.userPayload.getUsername());
		resonse.then().log().all();
		Assert.assertEquals(resonse.getStatusCode(), 200);
	...
	public void updateUserByName() {
		...
		Response resonse = UserEndPointsFromProperties.uppdateUser(this.userPayload.getUsername(), userPayload);
		resonse.then().log().all();
		...
		Response resonseAfterUpdate = UserEndPointsFromProperties.readUser(this.userPayload.getUsername());
	...
	public void deleteUserByName() {
		...
		Response resonseAfterDelete = UserEndPointsFromProperties.deleteUser(this.userPayload.getUsername());
